...
const menu = (
  <Menu theme="light" mode="horizontal" style={{padding:'1rem', fontSize:'14px', backgroundColor:'rgba(255,255,255, 0.5)'}}>
    <div>
...
const MenuItemSupport = () => {
  return (
    <Dropdown placement={'bottomCenter'} trigger={['click']} arrow={true} overlay={menu}>
      <a style={{color:'#5d5d5d'}} href={'index.html'} target='_parent' rel='noopener' className="ant-dropdown-link" onClick={e => e.preventDefault()}>
        Support us <DownOutlined />
      </a>
    </Dropdown>
  )
}
